...
Your task is to build out the project to the designs inside the `/src/assets/design` folder. You will find both a mobile and a desktop version of the design. 
